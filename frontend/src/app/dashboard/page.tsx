      ...
      <div className="lg:ml-64">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>Welcome back, John! 👋</h1>
              <p className={`mt-1 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>Here's your Web3 income overview for December 2024</p>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-600 font-mono text-sm">{userProfile.ensName}</p>
                  </div>
                </div>
